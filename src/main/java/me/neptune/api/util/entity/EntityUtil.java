package me.neptune.api.util.entity;

import com.mojang.authlib.GameProfile;
import me.neptune.Neptune;
import me.neptune.api.interfaces.Minecraftable;
import me.neptune.asm.ducks.IExplosion;
import me.neptune.asm.ducks.IRaycastContext;
import me.neptune.asm.ducks.IVec3d;
...
public class EntityUtil implements Minecraftable {
    ...
    public static PlayerEntity getClosestEnemy() {
        ...
        for (PlayerEntity player : mc.world.getPlayers()) {
            if (player != null && player.isAlive() && !player.equals(mc.player) && !Neptune.getFriendManager().isFriend(player)) {
