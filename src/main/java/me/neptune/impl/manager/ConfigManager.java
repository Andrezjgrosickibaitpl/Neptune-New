...
import me.neptune.api.value.util.EnumHelper;
...
public class ConfigManager implements Minecraftable {
    ...
    public static String PATH = Neptune.DIRECTORY.getAbsolutePath();
    ...
    public void init() {
        modules.addAll(Neptune.getModuleManager().getModules());
        loadConfig();
    ...
    public void savePrefix() {
        try {
            ...
            out.write(Neptune.getCommandManager().getPrefix());
            out.write("\r\n");
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void loadPrefix() {
        try {
            ...
            while ((line = br.readLine()) != null) {
                Neptune.getCommandManager().setPrefix(line);
            }
            br.close();
        } catch (Exception e) {
            e.printStackTrace();
